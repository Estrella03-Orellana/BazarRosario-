...
public class TecnologiaC extends JDialog {
    ...
    private final int ID_CATEGORIA = 2;
    ...
    public TecnologiaC(MainForm mainForm){
    ...
    private void hideCol(int pColumna) {
        this.tblTec.getColumnModel().getColumn(pColumna).setMaxWidth(0);
        this.tblTec.getColumnModel().getColumn(pColumna).setMinWidth(0);
        this.tblTec.getTableHeader().getColumnModel().getColumn(pColumna).setMaxWidth(0);
        this.tblTec.getTableHeader().getColumnModel().getColumn(pColumna).setMinWidth(0);
    }

    private Producto getProductFromTableRow() {
        Producto producto = null;
        try {
            int filaSelect = this.tblTec.getSelectedRow();
            int id = 0;

            if (filaSelect != -1) {
                id = (int) this.tblTec.getValueAt(filaSelect, 0);
            } else {
                JOptionPane.showMessageDialog(null,
