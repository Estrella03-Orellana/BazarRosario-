...
public class DeportesC extends JDialog {
    ...
    private final int ID_CATEGORIA = 7;
    ...
    public DeportesC(MainForm mainForm){
    ...
    private void hideCol(int pColumna) {
        this.tblDepo.getColumnModel().getColumn(pColumna).setMaxWidth(0);
        this.tblDepo.getColumnModel().getColumn(pColumna).setMinWidth(0);
        this.tblDepo.getTableHeader().getColumnModel().getColumn(pColumna).setMaxWidth(0);
        this.tblDepo.getTableHeader().getColumnModel().getColumn(pColumna).setMinWidth(0);
    }

    private Producto getProductFromTableRow() {
        Producto producto = null;
        try {
            int filaSelect = this.tblDepo.getSelectedRow();
            int id = 0;

            if (filaSelect != -1) {
                id = (int) this.tblDepo.getValueAt(filaSelect, 0);
            } else {
                JOptionPane.showMessageDialog(null,
